...
public class SoccerBall : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Debug.Log("SoccerBall collided with the Goal!");
            MadeGoal();
        }
    ...
    private void Update()
    {
        ...
        _pointsText.text = "Points: " + points.ToString("F1");
        _timeSinceGoal += Time.deltaTime;
        _timeText.text = "Time: " + _timeSinceGoal.ToString("F1");
    }    // STEP 6 -----------------------------------------------------------------
}
